<template>
  <div class="container register-container" :style="'min-height: '+minHeight">
    ...
    <div class="row">
      <input type="password" v-model="old" placeholder="原始密码，字母+数字组合，6--20位" class="input code-input">
    </div>
    <div class="row">
      <input type="password" v-model="xin" placeholder="新密码，字母+数字组合，6--20位" class="input">
    </div>
