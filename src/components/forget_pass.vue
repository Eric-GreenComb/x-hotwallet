<template>
  <div class="container register-container" :style="'min-height: '+minHeight">
    ...
    <div class="row">
        <input type="text" slot="right" v-model="code" maxlength="6" placeholder="短信验证码" class="input" >
        <!-- ↓↓关键代码是这里↓↓ -->
    ...
    <div class="row">
      <input type="password" v-model="xin" maxlength="20" placeholder="新密码 " class="input" >
    </div>
    ...
    methods: {
      ...
      register() {
        ...
        if (!myreg.test(this.userid)) {
          ...
          this.$dialog.alert({mes: '不能没有验证码哦 ...'});
        } else {
          var obj = {
          ...
          var str=''+this.userid+'/'+this.code+'/'+this.xin; //拼接POST请求参数
