<template>
  <div class="container register-container" :style="'min-height: '+minHeight">
    ...
    <div class="row">
      <input type="text" v-model="userID" placeholder="手机号" class="input">
    </div>
    <div class="row">
    ...
    <div class="row">
      ...
      <span class="code-btn" @click="getCode">获取</span>
    </div>
    <div class="row">
      <input type="password" v-model="passwd" placeholder="密码， 数字+字母组合，6--20位" class="input">
    </div>
    <div class="row">
      <input type="password" v-model="email" placeholder="确认密码，数字+字母组合，6--20位" class="input">
    </div>
